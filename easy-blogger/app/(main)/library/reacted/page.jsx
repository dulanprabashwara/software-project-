...
export default function Reacted() {
  ...
  if (isLoading) return <p className="px-8 mt-4"><Loader2 className="inline w-4 h-4 animate-spin mr-2 text-brand-primary" />Loading your interactions...</p>;

  if (interactedArticles.length === 0) return <div><p className="px-8 mt-4 text-brand-muted">You haven't Rated or Commented any article.</p></div>;
