    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm mb-8">
          <h2 className="text-lg font-semibold text-[#111827] mb-4">Top Performing Articles</h2>
            ...
            {[1, 2, 3].map((i) => (
              <div key={i} className="flex justify-between items-center pb-4 border-b border-gray-100 last:border-0">
                ...
                <div className="text-right">
                  <p className="font-semibold text-[#1ABC9C]">{(5 - i) * 1.2}K reads</p>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-lg font-semibold text-[#111827] mb-4">Engagement Over Time</h2>
