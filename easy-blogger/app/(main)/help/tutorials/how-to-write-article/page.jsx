      ...
      <div className="max-w-3xl mx-auto">
        ...
        <article className="prose prose-emerald lg:prose-lg mx-auto">
          ...
          <div className="space-y-12">
            ...
            {/* Step 1 */}
            <section>
              <h2 className="text-2xl font-semibold text-brand-black mb-4">Step 1: Open the Editor</h2>
            ...
            {/* Step 2 */}
            <section>
              <h2 className="text-2xl font-semibold text-brand-black mb-4">Step 2: Add Title and Content</h2>
              <p className="text-brand-muted mb-4">
            ...
            {/* Step 3 */}
            <section>
              <h2 className="text-2xl font-semibold text-brand-black mb-4">Step 3: Publish Your Article</h2>
              <p className="text-brand-muted mb-4">
