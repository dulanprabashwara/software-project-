    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <header className="w-full px-6 md:px-12 py-4 flex items-center justify-between border-b border-[#E5E7EB]">
        ...
        <nav className="flex items-center gap-6">
          <a href="#" className="text-sm text-[#6B7280] hover:text-[#000000] transition-colors hidden md:block">
            Our story
          </a>
          <a href="#" className="text-sm text-[#6B7280] hover:text-[#000000] transition-colors hidden md:block">
            Membership
          ...
          <a href="#" className="text-sm text-[#6B7280] hover:text-[#000000] transition-colors">
            Sign in
          </a>
          <a 
            href="/home" 
        ...
        <div className="w-full max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-stretch">
          ...
          <div className="flex-1 relative hidden md:block pl-8 overflow-visible">
            <div className="relative w-full h-[500px]">
              ...
              <svg className="absolute top-24 left-8 w-48 h-48" viewBox="0 0 192 192">
                <circle cx="96" cy="96" r="85" fill="none" stroke="#D1D5DB" strokeWidth="1" />
                <line x1="35" y1="157" x2="157" y2="35" stroke="#D1D5DB" strokeWidth="1" />
              </svg>
              
              {/* Light blue parallelogram/triangle shape */}
              <svg className="absolute top-32 left-20 w-80 h-72 z-0" viewBox="0 0 320 288">
                <polygon 
                  points="60,0 320,120 260,288 0,168" 
                  fill="#DBEAFE"
                />
              </svg>
              ...
              <svg className="absolute top-52 -right-12 w-64 h-40 z-40" viewBox="0 0 256 160">
                <path 
      ...
      <footer className="w-full py-6">
        <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6 text-sm text-[#6B7280]">
          <a href="#" className="hover:text-[#111827] hover:underline transition-colors">Help</a>
          <a href="#" className="hover:text-[#111827] hover:underline transition-colors">Status</a>
          <a href="#" className="hover:text-[#111827] hover:underline transition-colors">About</a>
          <a href="#" className="hover:text-[#111827] hover:underline transition-colors">Careers</a>
          <a href="#" className="hover:text-[#111827] hover:underline transition-colors">Press</a>
          <a href="#" className="hover:text-[#111827] hover:underline transition-colors">Blog</a>
          <a href="#" className="hover:text-[#111827] hover:underline transition-colors">Privacy</a>
          <a href="#" className="hover:text-[#111827] hover:underline transition-colors">Terms</a>
          <a href="#" className="hover:text-[#111827] hover:underline transition-colors">Text to speech</a>
          <a href="#" className="hover:text-[#111827] hover:underline transition-colors">Teams</a>
        </div>
      </footer>
    </div>
  );
