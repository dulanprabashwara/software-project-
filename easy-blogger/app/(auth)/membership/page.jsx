  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <section className="w-full max-w-5xl mx-auto px-6 md:px-12 pt-20 pb-16 text-center">
        <h1
          className="text-5xl md:text-7xl font-bold text-brand-black leading-tight tracking-tight mb-6"
          style={{ fontFamily: "Georgia, serif" }}
        >
          Fuel great thinking.
        </h1>
      ...
      <section className="w-full max-w-5xl mx-auto px-6 md:px-12 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          <div className="bg-white border-2 border-[#E5E7EB] rounded-2xl p-8">
            <h3 className="text-2xl font-bold text-brand-black mb-2">Free</h3>
            <div className="mb-6">
              <span className="text-4xl font-bold text-brand-black">$0</span>
              <span className="text-brand-muted text-base">/month</span>
            </div>

            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3">
                <Check className="w-5 h-5 text-brand-muted mt-0.5 shrink-0" />
              ...
              <li className="flex items-start gap-3">
                <Check className="w-5 h-5 text-brand-muted mt-0.5 shrink-0" />
                <span className="text-brand-muted text-sm">Community access</span>
              </li>
            </ul>

            <Link
              href="/signup"
              className="block w-full py-3 px-6 border-2 border-[#E5E7EB] text-brand-muted rounded-full text-sm font-medium hover:bg-[#F9FAFB] transition-all hover:-translate-y-0.5 hover:shadow-md text-center"
            >
              Get Started Free
            </Link>
          </div>
          ...
          {/* Premium Plan Card */}
          <div className="bg-white border-2 border-brand-primary rounded-2xl p-8 relative">
            {/* Most Popular Badge */}
            ...
            <div className="flex items-center gap-2 mb-2">
              <h3 className="text-2xl font-bold text-brand-black">Premium</h3>
              <Zap className="w-6 h-6 text-[#FBBF24] fill-[#FBBF24]" />
            </div>

            <div className="mb-6">
              <span className="text-4xl font-bold text-brand-black">$9.99</span>
              <span className="text-brand-muted text-base">/month</span>
            </div>
            ...
            <Link
              href="/signup"
              className="block w-full py-3 px-6 bg-brand-primary hover:bg-brand-primary-hover text-white rounded-full text-sm font-medium transition-all hover:-translate-y-0.5 hover:shadow-md text-center"
            >
              Upgrade to Premium
            </Link>
          </div>
      ...
      <section className="bg-[#F9FAFB] py-20 text-center">
        ...
        <p className="text-base text-brand-muted mb-8 max-w-md mx-auto">
          Join a community of curious minds. Start your membership today.
        </p>
        <Link
          href="/signup"
          className="inline-block px-8 py-3 bg-brand-primary hover:bg-brand-primary-hover text-white text-base font-medium rounded-full hover:scale-105 transition-all duration-300"
        >
          Get started
        </Link>
      </section>
